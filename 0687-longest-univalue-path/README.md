<h2><a href="https://leetcode.com/problems/longest-univalue-path/?envType=problem-list-v2&envId=binary-tree">687. Longest Univalue Path</a></h2><h3>Medium</h3><hr><p>Given the <code>root</code> of a binary tree, return <em>the length of the longest path, where each node in the path has the same value</em>. This path may or may not pass through the root.</p>
